...
//  Moment
//
//  Created by hyuapp3 on 2018. 5. 31..
...
class CalendarView: UIView, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, MonthViewDelegate {
    ...
    convenience init(theme: CalendarTabViewController.MyTheme) {
        self.init()
    ...
    func initializeView() {
        ...
        //let indexPath = IndexPath(row: todaysDate + firstWeekDayOfMonth - 2, section: 0)
        //print(indexPath.row)
...
//        }
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        selectedDate = String.dateFormatter.date(from: "\(presentYear)-\(presentMonthIndex)-\(indexPath.row - firstWeekDayOfMonth + 2)")
